...
<h2><img src="<?php echo MC4WP_PLUGIN_URL . 'assets/img/menu-icon.png'; ?>" /> <?php _e( 'MailChimp for WordPress', 'mailchimp-for-wp' ); ?>: <?php _e( 'Reports', 'mailchimp-for-wp' ); ?></h2>
	...
	<h2 class="nav-tab-wrapper">  
		<a href="?page=mc4wp-pro-reports&tab=statistics" class="nav-tab <?php echo ($tab === 'statistics') ? 'nav-tab-active' : ''; ?>"><?php _e( 'Statistics', 'mailchimp-for-wp' ); ?></a>
		<a href="?page=mc4wp-pro-reports&tab=log" class="nav-tab <?php echo ($tab === 'log') ? 'nav-tab-active' : ''; ?>"><?php _e( 'Log', 'mailchimp-for-wp' ); ?></a>
	</h2> 
