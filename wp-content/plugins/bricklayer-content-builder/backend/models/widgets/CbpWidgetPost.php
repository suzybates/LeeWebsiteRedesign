<?php
if (!class_exists('CbpWidgetPost')):

    class CbpWidgetPost extends CbpWidget
    {

        public function __construct()
        {
            parent::__construct(
                    /* Base ID */'cbp_widget_post',
                    /* Name */ 'Post', array('description' => 'This is a Post brick.', 'icon'        => 'fa fa-list-alt fa-3x'));
        }
        ...
        public function widget($atts, $content)
        {
            ...
            <div class="<?php echo CbpWidgets::getDefaultWidgetCssClass(); ?> <?php echo $type; ?> <?php echo $padding; ?><?php echo $custom_css_classes; ?><?php echo $css_class; ?> <?php echo $padding; ?>">
                ...
                <div class="<?php echo $type; ?>_meta">
                    <?php $this->entryMeta(); ?>
                    <?php edit_post_link(__('Edit', CBP_APP_TEXT_DOMAIN), '<span class="edit-link">', '</span>'); ?>
                </div>
