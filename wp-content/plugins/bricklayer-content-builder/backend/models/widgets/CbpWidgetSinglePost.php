<?php
if (!class_exists('CbpWidgetSinglePost')):

    class CbpWidgetSinglePost extends CbpWidget
    {

        public function __construct()
        {
            parent::__construct(
                    /* Base ID */'cbp_widget_single_post',
                    /* Name */ 'Blog Post', array('description' => 'This is a Single Blog Post brick.', 'icon'        => 'fa fa-list-alt fa-3x'));
        }
