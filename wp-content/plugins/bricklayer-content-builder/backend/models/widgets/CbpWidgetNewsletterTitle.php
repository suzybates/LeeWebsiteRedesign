<?php
if (!class_exists('CbpWidgetNewsletterTitle')):

    class CbpWidgetNewsletterTitle extends CbpWidget
    {

        public function __construct()
        {
            parent::__construct(
                    /* Base ID */'cbp_widget_newsletter_title',
                    /* Name */ 'Newsletter Title', array('description' => 'This is a Newsletter Title brick.', 'icon'        => 'fa fa-list-alt fa-3x'));
        }
        ...
        public function form($instance)
        {
            ...
            CbpWidgetFormElements::select(array(
                ...
                'description_title' => $this->translate('Link to Newsletter?'),
            ));
        }
        ...
        public function widget($atts, $content)
        {
            extract(shortcode_atts(array(
                        'type'               => 'cbp_widget_newsletter_title',
                        'css_class'          => '',
                        'custom_css_classes' => '',
                        'padding'            => '',
                        'title_size'         => 'h2',
