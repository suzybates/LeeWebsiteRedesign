<?php
if (!class_exists('CbpWidgetRowInner')):

    class CbpWidgetRowInner extends CbpWidget
    {

        public function __construct()
        {
            parent::__construct(
                    /* Base ID */'cbp_widget_row_inner',
                    /* Name */ 'Inner Row', array('description' => 'This is an Inner Row brick', 'icon'        => 'fa fa-font fa-3x'));
        }
