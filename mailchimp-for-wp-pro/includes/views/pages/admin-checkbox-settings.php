	...
	<form method="post" action="options.php">
		...
		<table class="form-table">
			...
			<tr valign="top">
				<th scope="row"></th>
				<td colspan="2">
					<p><?php printf( __( 'Use %s in your Contact Form 7 mark-up to add a sign-up checkbox to your CF7 forms.</p>', 'mailchimp-for-wp' ), '<code>[mc4wp_checkbox "Label text"]</code>' ); ?></p>
				</td>
			</tr>
			<?php } ?>
			<tr valign="top">
